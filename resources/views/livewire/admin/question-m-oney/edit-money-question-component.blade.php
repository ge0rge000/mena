          ...
          <div class="card-content collapse show">
            <div class="card-body">
              ...
              <form class="form" wire:submit.prevent="edit_question">
                                    ...
                                    <form name="frm-login" wire:submit.prevent="storeQuestion" >
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <input type="text" id="projectinput1" class="form-control" placeholder="question"
                                              name="fname" wire:model="question">
                                            </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <input type="text" id="projectinput1" class="form-control" placeholder="answer"
                                        ...
                                        @if($type=="block")
                                          <div class="col-md-12">
                                            <div class="form-group">
                                              <label for="projectinput1">blocks</label>
                ...
                @endif
                <label for="projectinput1">Year Type</label>

                <fieldset class="form-group">
                    <select class="form-control" id="basicSelect" wire:model="year_type">
                      <option value="1">Select Option</option>
