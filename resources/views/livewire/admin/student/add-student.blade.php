                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form wire:submit.prevent="store" enctype="multipart/form-data"  id="addStudent">
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">student mobile</label>
                                <input type="number" class="form-control" wire:model="mobile_phone" id="exampleFormControlInput1" placeholder="enter student name">
                                @error('mobile_phone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
